...
export const PAGE_FEATURE_ROUTES: FeatureRouteEntry[] = [
  ...
  { scope: "page", prefix: "/human-resources/payouts", featureKey: "hr.settlements" },
  ...
  { scope: "page", prefix: "/schools/lesson-plans", featureKey: "schools.core" },
  { scope: "page", prefix: "/schools/resources", featureKey: "schools.core" },
  ...
  { scope: "page", prefix: "/gold/payouts", featureKey: "gold.settlements" },
  { scope: "page", prefix: "/gold/settlement/payouts", featureKey: "gold.settlements" },
  ...
  { scope: "page", prefix: "/scrap-metal/settlements", featureKey: "hr.settlements" },
  ...
  { scope: "page", prefix: "/management/master-data/operations/gold-expense-types", featureKey: "gold.settlements" },
...
export const API_FEATURE_ROUTES: FeatureRouteEntry[] = [
  ...
  { scope: "api", prefix: "/api/hr/payout-batches", featureKey: "hr.settlements" },
  ...
  { scope: "api", prefix: "/api/gold/shift-allocations", featureKey: "gold.settlements" },
  { scope: "api", prefix: "/api/gold/expense-types", featureKey: "gold.settlements" },
