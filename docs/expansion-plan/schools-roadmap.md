...
| S-4.6 | As anyone in a school, I reach a list through its year group rather than scrolling one list of everybody | Year group is a route, not a filter: a picker, then the register for that group. Applied to students; the same shape is owed to attendance, results and fees | `wip` |
