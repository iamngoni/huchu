...
function AlertDialogMedia({
  ...
  return (
    <div
      ...
      className={cn(
        "mb-2 inline-flex size-16 items-center justify-center rounded-[var(--card-radius)] border border-[var(--border-default)] bg-[var(--surface-subtle)] text-[var(--text-strong)] shadow-[var(--surface-frame-shadow)] sm:group-data-[size=default]/alert-dialog-content:row-span-2 *:[svg:not([class*='size-'])]:size-8",
        className
      )}
      {...props}
    />
